...
function init() {
  ...
  addRoom("room1");
  changeRoom("lobby");
  addMessage("lobby", "Admin", "Welcome! Open another browser tab and send yourself a message.", true);
  addMessage("room1", "Admin", "This is an additional room.  You can create more by using the field in the bottom left of the screen.", true);
